...
function generarFeedback() {
    ...
    if (template === 'wrong-structure') {
        ...
        feedback = `Hola ${nombre}, ¡espero que todo esté yendo bien! 🤗 Hoy estoy realizando QA aleatorio y me encontré con <a href="${link}" target="_blank">esta propiedad tuya</a>, Después de revisarla cuidadosamente, llegué a la conclusión de que no fue identificada correctamente. Mis motivos son: ${motivos}. Por favor, déjame saber si tienes alguna duda al respecto. ¡Gracias por tu tiempo!`;

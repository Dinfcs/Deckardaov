...
(async function() {
    ...
    const scripts = [
        ...
        { urlPattern: /^https:\/\/(login-spatialstream\.prod\.lightboxre\.com\/memberpages\/(login|default)\.aspx|pqweb\.parcelquest\.com\/#login)$/, scriptUrl: 'https://dinfcs.github.io/Deckardaov/DeckardScripts/ExternalScripts/AutologinLB-PQ.js' }

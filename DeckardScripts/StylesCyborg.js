...
(function() {
    ...
    .cyborg-str-tool button:not(#window_vetting_dlg *):not(#vetting_data_footer *):not(#btn_submit_vetting_dlg):not([style*="Nearby Parcels"]):not(.fancybox-button):not([data-test-id="float-window-minimize-or-restore-btn"]):not([data-test-id="float-window-close-btn"]):not(.pop_up_header_container *),
    .cyborg-str-tool .btn:not(#window_vetting_dlg *):not(#vetting_data_footer *):not(#btn_submit_vetting_dlg):not([style*="Nearby Parcels"]):not(.fancybox-button):not([data-test-id="float-window-minimize-or-restore-btn"]):not([data-test-id="float-window-close-btn"]):not(.pop_up_header_container *),
    ...
    /* Enlaces */
    .cyborg-str-tool a:not(#window_vetting_dlg *):not(#vetting_data_footer *):not(.pop_up_header_container *) {
        color: #919292 !important; /* Gris para enlaces sin abrir */
        text-decoration: none !important;
        font-weight: normal !important;
    }

    .cyborg-str-tool a:visited:not(#window_vetting_dlg *):not(#vetting_data_footer *):not(.pop_up_header_container *) {
        color: #23A9D8 !important; /* Azul para enlaces visitados */
    }

    .cyborg-str-tool a:hover:not(#window_vetting_dlg *):not(#vetting_data_footer *):not(.pop_up_header_container *) {
        color: #23A9D8 !important;
        text-decoration: underline !important;
    }

    /* Tablas */
    .cyborg-str-tool table:not(#window_vetting_dlg *):not(#vetting_data_footer *):not(.table-hover):not(.pop_up_header_container *) {
    ...
    .cyborg-str-tool table th:not(#window_vetting_dlg *):not(#vetting_data_footer *):not(.bg-secondary):not(.pop_up_header_container *) {
    ...
    .cyborg-str-tool table input[type="text"]:not(#window_vetting_dlg *):not(#vetting_data_footer *):not(.pop_up_header_container *) {
    ...
    .cyborg-str-tool .listing_quick_view_apn_or_address_info:not(#window_vetting_dlg *):not(#vetting_data_footer *) {
        font-weight: normal !important;
    }
        `);
